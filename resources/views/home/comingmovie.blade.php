...
<body class="">
            ...
            <div class="filter-1">
                ...
                <div class="filter-4">
                    ...
                    <form id="filterForm" method="GET" action="{{ route('allmovie.filter') }}">
                        ...
                        <button type="button" id="filterButton" class="btn btn-primary" style="width:100%">Execute</button>
    ...
    <script>
        $(document).ready(function() {
            // Click event handler for genre items
            $('.item-genre').on('click', function() {
                // Toggle the "selected" class for the clicked genre item
                $(this).toggleClass('selected');

                // Update the hidden input value with selected genres
            ...
            // Function to update the hidden input value with selected genres
            ...
            // Check if there are selected genres in the URL and update the UI
